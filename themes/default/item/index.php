...
<form class="search-form" method="get">
	...
	<div class="row">
		...
		<div class="large-6 columns">
			...
			<div class="large-6 columns">
				<label for="npc_sell">Value:</label>
	...
	<div class="row">
		...
		<div class="large-6 columns">
			...
			<input type="button" value="Reset" onclick="reload()" class="button secondary"/>
		</div>
	</div>
</form>
<?php if ($items): ?>
