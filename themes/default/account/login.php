...
<div id="main_login_error" style="display: none;"><!-- intentionally left blank --></div>

<?php if ($auth->actionAllowed('account', 'create')): ?>
<p><?php printf(Flux::message('LoginPageMakeAccount'), $this->url('account', 'create', array('isAjax' => '1'))); ?></p>
<?php endif ?>
	...
	<table class="large-10 large-centered columns">
		...
		<tr>
			<td></td>
			<td>
				<button class=" button" onclick="doLogin(this, '<?php echo $this->url('account', 'login', array('isAjax' => '1', 'return_url' => $params->get('return_url'))) ?>', 'main');">
